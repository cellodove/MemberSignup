...
<body>
    <fieldset>
        <h1>회원 가입</h1>
        <form action="../MemberCreateServlet">
            <table id="jointable">
                <tr>
                    <th>아이디</th>
                ...
                <tr>
                    <th>비밀번호</th>
                    <td><input type="password" name="passwd" id="pwd" size="12"
                        maxlength="12" /></td>
                </tr>
 
                <tr>
                    <th>비밀번호확인</th>
                    <td><input type="password" name="passwdk" id="pwd2" size="12"
                        maxlength="12" /></td>
                </tr>
                ...
                <tr>
                    <th>전화번호</th>
                    <td><input type="text" name="tel1" id="tel1" size="4"maxlength="4" />- 
                ...
                <tr>
                    <th>주소</th>
                    <td><input type="text" name="address" id="addr" maxlength="100" />
                    </td>
                </tr>
